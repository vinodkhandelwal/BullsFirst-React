...
describe('Account Page', () =>{
    it('Test1', () => {
        const props = {
            ...
            actions: {addAccount: ()=>{return Promise.resolve();}, loadAccounts: ()=>{return Promise.resolve();}, loadAccountsSuccess: ()=>{return Promise.resolve();}}
        }

        //const wrapper = mount(<AccountsPage {...props}/>);
    });
});
